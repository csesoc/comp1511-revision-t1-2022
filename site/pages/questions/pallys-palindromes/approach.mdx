...
For this question, we need to firstly read in the input. To do this, we can use `fgets` to help read in the line of input. We can see the syntax of this below:
...
// Remove new line character from input string, because `fgets` takes in the whole line, including the newline character at the end.
str[len] = '\0';
```
